...
document.addEventListener("DOMContentLoaded", function () {
    const navToggle = document.getElementById("menu"); // Get the menu button
    const navMenu = document.querySelector("nav ul"); // Get the navigation menu
    ...
    document.getElementById("currentyear").textContent = new Date().getFullYear(); // Display the current year
    document.getElementById("lastModified").textContent = document.lastModified; // Display the last modification date
